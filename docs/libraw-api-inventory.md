...
- `deferred`: in scope for later tasks.
...
| `libraw_open_wfile` | `libraw.h` | `deferred` | tracked for a future task |
| `libraw_open_wfile_ex` | `libraw.h` | `deferred` | tracked for a future task |
...
| `libraw_callbacks_t` | `libraw_types.h` | `deferred` | tracked for a future task |
