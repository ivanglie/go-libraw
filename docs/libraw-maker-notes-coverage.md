...
| --- | --- |
| `testdata/RAW_CANON_R6.CR3` | Canon maker notes |
| `testdata/RAW_NIKON_ZFC.NEF` | Nikon maker notes |
| `testdata/RAW_RICOH_GR3X.DNG` | Ricoh/DNG zero-value policy |
| `testdata/RAW_SONY_ILCE-7M4.ARW` | Sony maker notes |
